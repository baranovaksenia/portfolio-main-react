      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="subtitle">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Accusantium fugit earum
            repellendus cupiditate reprehenderit assumenda natus iure optio necessitatibus sit?
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:gap-x-8">
          <div className="flex flex-1 flex-col items-start space-y-8 mb-12 lg:mb-0 lg:pt-2">
            {contact.map((item, index) => {
              ...
              return (
                <div className="flex flex-col gap-x-4 lg:flex-row" key={index}>
